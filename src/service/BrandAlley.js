...
export async function processBrandAlley() {
  try {
    const marketplaceId = "fdc181a4-e714-4922-a282-6a76a33513d2";

    const datefin = currentDate();
    const dateinicio = currentDateMenos(5);

    const myHeaders = {
      Authorization: "e8da471c-56c9-493f-92ec-761b4da1d263",
      Accept: "application/json",
    };

    let endpoint = `https://brandalleyuk-prod.mirakl.net/api/orders?paginate=false&start_date=${dateinicio}T00:00:00.000000Z&end_date=${datefin}T23:59:00.000000Z&order_state_codes=WAITING_ACCEPTANCE,SHIPPING`;
    let orders = [];
